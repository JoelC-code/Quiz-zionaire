...
<!--Used for showing the list-->
        ...
        <div class="w-full mt-10 gap-5 flex md:flex-row flex-col">
            ...
            <button
                ...
                value="publishQuiz" onclick="showQuizDeleteWarning()">Delete Quiz</button>
        </div>
    </main>
    ...
    <div id="DeleteQuestionWarning" class="fixed inset-0 bg-black bg-opacity-80 flex justify-center items-center hidden z-50">
        <div class="relative bg-white rounded-lg overflow-hidden max-w-3xl w-[90%] p-6">
            ...
            <div class="flex justify-end gap-4">
                <button onclick="closeQuestionDeleteWarning()" id="cancelDelete" class="cursor-pointer bg-gray-300 text-white px-4 py-2 rounded-lg"
                    type="submit" value="-1">Cancel</button>
                <button onclick="closeQuestionDeleteWarning()" id="confirmDelete"
                    class="cursor-pointer bg-red-600 text-white px-4 py-2 rounded-lg">Confirm</button>
            </div>
        </div>
    </div>
