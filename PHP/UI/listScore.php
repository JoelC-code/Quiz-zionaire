    ...
    <nav class="p-5 bg-blue-700 rounded-b-xl flex flex-row justify-between">
        ...
        <div class="block md:hidden group">
            ...
            <div id="dropdownMenu"
                ...
                <ul class="p-4 gap-4">
                    <li><a href="MainMenu.php" class="text-white w-full h-15 hover:bg-white hover:text-blue-800 rounded-lg block p-2">Home</a></li>
                    <li><a href="#" class="text-white w-full h-15 hover:bg-white hover:text-blue-800 rounded-lg block p-2">List Nilai</a></li>
                    <li><a href="Login.php" class="text-white w-full h-15 hover:bg-white hover:text-blue-800 rounded-lg block p-2">Logout</a></li>
                </ul>
            </div>
        </div>
